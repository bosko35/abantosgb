...
export default function MissionVision() {
  return (
    <section id="misyon-vizyon" className="relative py-16 md:py-24 bg-white overflow-hidden">
                ...
                <div className="relative flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-3 text-brand-text/70 leading-relaxed">
                      Çalışan sağlığını ve iş güvenliğini bütünsel bir yaklaşımla ele alarak; mevzuata tam uyumlu, ölçülebilir ve sürdürülebilir çözümler üretmek.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative h-full rounded-2xl border border-white/40 bg-white/80 p-8 shadow-soft backdrop-blur-md">
                ...
                <div className="relative flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="mt-2 h-0.5 w-16 bg-brand-gold" />
                    <p className="mt-3 text-brand-text/70 leading-relaxed">
                      İş sağlığı ve güvenliğinde fark yaratan yenilikçi uygulamalarla bölgenin en güvenilen iş ortağı olmak ve güvenlik kültürünü yaygınlaştırmak.
                    </p>
                  </div>
                </div>
              </div>
